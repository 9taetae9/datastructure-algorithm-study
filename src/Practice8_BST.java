//주어진 BST에서 두 노드의 합이 target 값이 되는 경우가 있는지 확인하시오
...
public class Practice8_BST {
    ...
    public static void main(String[] args) {
        Integer[] data = new Integer[]{5,3,6,2,4,null,7};
        int target= 9;
        solution(data,target);

        data = new Integer[]{5,3,6,2,4,null,null,7};
        target=28;
        solution(data,target);
    }
}
