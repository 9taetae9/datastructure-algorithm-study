...
public class Practice4_MST {
    ...
    public static int prim(){
        ...
        int weightSum = 0;
        int maxWeight = 0; //가장큰 것 하나 총합에서 뺴기
