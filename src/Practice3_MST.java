//2250년, 인류는 지구뿐 아니라 여러 행성을 다니며 살고 있다.
//이 행성 간을 빨리 오가기 위해 새롭게 터널을 구축하려 한다.
//
//행성은 (x,y,z) 좌표로 주어진다.
//행성1: (x1, y1, z1), 행성2: (x2, y2, z2)라고 하면
//이때 행성간 터널 연결 비용은 min(|x1-x2|, |y1-y2|, |z1-z2|)로 계산한다.
//
//n개의 행성 사이를 n-1개의 터널로 연결하는데 드는 최소 비용을 구하시오.
//
//입출력 예시
//입력
